...
public class Checker {
    ...
    static void addStaticRules(List<TileCell> cells) {
        addPerfectRules(cells, PERFECT_ONE, 1);
        addPerfectRules(cells, PERFECT_TWO, 2);
        addPerfectRules(cells, PERFECT_THREE, 3);
        addPerfectRules(cells, PERFECT_FOUR, 4);
        addPerfectRules(cells, PERFECT_SIX, 6);
        addPerfectRules(cells, PERFECT_SEVEN, 7);

        addSingleLineRules(cells, SINGLE_LINE);

        addHorizontalRules(cells, SUSPICIOUS_TWO, 2);
        addHorizontalRules(cells, THREE, 3);
        addHorizontalRules(cells, FOUR, 4);
        addHorizontalRules(cells, FIVE, 5);
    }
